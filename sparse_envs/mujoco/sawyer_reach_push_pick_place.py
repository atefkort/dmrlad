...
from sparse_envs.env_util import get_asset_full_path
from sparse_envs.utils.rotation import euler2quat
from sparse_envs.mujoco.base import SawyerXYZEnv
...
class SawyerReachPushPickPlaceEnv(SawyerXYZEnv):
    ...
    def compute_reward(self, actions, obs, mode="general", task_type="reach"):
        ...
        def compute_reward_push_sparse(actions, obs, mode):
            ...
            pushRew = (pushDist <= push_m) - 1.0
            reward = pushRew
            return [reward, reachRew, reachDist, pushRew, pushDist, None, None, None, fingerCOM]
