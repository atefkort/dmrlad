...
class HalfCheetahSparseVelocityEnv(NonStationaryGoalVelocityEnv, MujocoEnv, utils.EzPickle):
    ...
    def step(self, action):
        ...
        self.steps += 1
        return ob, reward, done, dict(reward_run=reward_run, reward_ctrl=reward_ctrl,sparse_reward=sparse_reward,
